...
public class EmailService {
  ...
  public void enviarCorreoAutenticacion(String destinatario, String token) {
	    String asunto = "Bienvenido al sistema de administrador de Canciones";
	    String mensaje = "<html><body><h1>Usuario Almacenado</h1> <p>Comprueba tu cuenta</p><p>Tu cuenta ya esta lista, solo debes comprobarla en el siguiente enlace: </p>"
	            + "<a href=\"http://localhost:5173/confirmacion/" + token + "\">Haz clic aquí para verificar tu cuenta</a></body></html>";
